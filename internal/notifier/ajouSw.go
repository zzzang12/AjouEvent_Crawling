...
func (source *AjouSwSource) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (source *AjouSwSource) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (source *AjouSwSource) sendNoticeToSlack(notice Notice) {

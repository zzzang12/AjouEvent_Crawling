...
type AjouPolNotifier BaseNotifier

func (AjouPolNotifier) New() *AjouPolNotifier {
  fsDocID := "PoliticalScienceDiplomacy"
  ...
  return &AjouPolNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://pol.ajou.ac.kr/pol/community/community04.jsp",
    Source:            "[정치외교학과]",
    ChannelID:         "정치외교학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouPolNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouPolNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouPolNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouPolNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouPolNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouPolNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouPolNotifier) sendNoticeToSlack(notice Notice) {

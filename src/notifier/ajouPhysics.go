...
type AjouPhysicsNotifier BaseNotifier

func (AjouPhysicsNotifier) New() *AjouPhysicsNotifier {
	fsDocID := "ajouPhysics"
	...
	return &AjouPhysicsNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://physics.ajou.ac.kr/physics/board/board01.jsp",
		Source:            "[물리학과]",
		ChannelID:         "물리학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouPhysicsNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouPhysicsNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouPhysicsNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouPhysicsNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouPhysicsNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouPhysicsNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouPhysicsNotifier) sendNoticeToSlack(notice Notice) {

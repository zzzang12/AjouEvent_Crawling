...
type AjouFENotifier BaseNotifier

func (AjouFENotifier) New() *AjouFENotifier {
	fsDocID := "FinancialEngineering"
	...
	return &AjouFENotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://fe.ajou.ac.kr/fe/notice/notice.do",
		Source:            "[금융공학과]",
		ChannelID:         "금융공학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouFENotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouFENotifier) scrapeNotice() []Notice {
...
func (notifier *AjouFENotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouFENotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouFENotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouFENotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouFENotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouFENotifier) sendNoticeToSlack(notice Notice) {

...
type AjouEnglishNotifier BaseNotifier

func (AjouEnglishNotifier) New() *AjouEnglishNotifier {
  fsDocID := "EnglishLanguageLiterature"
  ...
  return &AjouEnglishNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://ell.ajou.ac.kr/english/board/board01.jsp",
    Source:            "[영어영문학과]",
    ChannelID:         "영어영문학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouEnglishNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouEnglishNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouEnglishNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouEnglishNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouEnglishNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEnglishNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouEnglishNotifier) sendNoticeToSlack(notice Notice) {

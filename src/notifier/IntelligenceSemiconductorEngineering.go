...
type AjouAISemiNotifier BaseNotifier

func (AjouAISemiNotifier) New() *AjouAISemiNotifier {
  fsDocID := "IntelligenceSemiconductorEngineering"
  ...
  return &AjouAISemiNotifier{
    BoxCount:          int(dbData["box"].(int64)),
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://aisemi.ajou.ac.kr/aisemi/board/notice.do",
    Source:            "[지능형반도체공학과]",
    ChannelID:         "지능형반도체공학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#cms-content > div > div > div.bn-list-common01.type01.bn-common-cate.bn-common > table > tbody > tr:not([class$=\"b-top-box\"])",
    BoxNoticeSelector: "#cms-content > div > div > div.bn-list-common01.type01.bn-common-cate.bn-common > table > tbody > tr[class$=\"b-top-box\"]",
  }
}

func (notifier *AjouAISemiNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouAISemiNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouAISemiNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouAISemiNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouAISemiNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouAISemiNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouAISemiNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouAISemiNotifier) sendNoticeToSlack(notice Notice) {

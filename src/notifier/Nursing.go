...
type AjouNursingNotifier BaseNotifier

func (AjouNursingNotifier) New() *AjouNursingNotifier {
  fsDocID := "Nursing"
  ...
  return &AjouNursingNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://www.ajoumc.or.kr/nursing/board/commBoardNRNewsList.do",
    Source:            "[간호대학]",
    ChannelID:         "간호대학-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouNursingNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouNursingNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouNursingNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouNursingNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouNursingNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouNursingNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouNursingNotifier) sendNoticeToSlack(notice Notice) {

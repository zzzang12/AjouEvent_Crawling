...
type AjouMedicineNotifier BaseNotifier

func (AjouMedicineNotifier) New() *AjouMedicineNotifier {
	fsDocID := "ajouMedicine"
	...
	return &AjouMedicineNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://www.ajoumc.or.kr/medicine/board/commBoardUVNoticeList.do",
		Source:            "[의과대학]",
		ChannelID:         "의과대학-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouMedicineNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouMedicineNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouMedicineNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouMedicineNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouMedicineNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouMedicineNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouMedicineNotifier) sendNoticeToSlack(notice Notice) {

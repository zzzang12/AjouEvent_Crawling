...
type AjouChembioNotifier BaseNotifier

func (AjouChembioNotifier) New() *AjouChembioNotifier {
  fsDocID := "AppliedChemistryBiologicalEngineering"
  ...
  return &AjouChembioNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://chembio.ajou.ac.kr/chembio/board/board01.jsp",
    Source:            "[응용화학생명공학]",
    ChannelID:         "응용화학생명공학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouChembioNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouChembioNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouChembioNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouChembioNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouChembioNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouChembioNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouChembioNotifier) sendNoticeToSlack(notice Notice) {

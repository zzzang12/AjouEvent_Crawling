...
type AjouArchNotifier BaseNotifier

func (AjouArchNotifier) New() *AjouArchNotifier {
  fsDocID := "Architecture"
  ...
  return &AjouArchNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://arch.ajou.ac.kr/arch/board/board01.jsp",
    Source:            "[건축학과]",
    ChannelID:         "건축학과-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouArchNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouArchNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouArchNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouArchNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouArchNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouArchNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouArchNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouPsychologyNotifier BaseNotifier

func (AjouPsychologyNotifier) New() *AjouPsychologyNotifier {
	fsDocID := "ajouPsychology"
	...
	return &AjouPsychologyNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://apsy.ajou.ac.kr/apsy/community/community04.jsp",
		Source:            "[심리학과]",
		ChannelID:         "심리학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouPsychologyNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouPsychologyNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouPsychologyNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouPsychologyNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouPsychologyNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouPsychologyNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouPsychologyNotifier) sendNoticeToSlack(notice Notice) {

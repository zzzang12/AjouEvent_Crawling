...
type AjouFrenchNotifier BaseNotifier

func (AjouFrenchNotifier) New() *AjouFrenchNotifier {
  fsDocID := "FrenchLanguageLiterature"
  ...
  return &AjouFrenchNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://france.ajou.ac.kr/france/board/board01.jsp",
    Source:            "[불어불문학과]",
    ChannelID:         "불어불문학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouFrenchNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouFrenchNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouFrenchNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouFrenchNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouFrenchNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouFrenchNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouFrenchNotifier) sendNoticeToSlack(notice Notice) {

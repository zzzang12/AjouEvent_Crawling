...
type AjouInternationalNotifier BaseNotifier

func (AjouInternationalNotifier) New() *AjouInternationalNotifier {
	fsDocID := "ajouInternational"
	...
	return &AjouInternationalNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://ajou.ac.kr/isa/support/notice.do",
		Source:            "[국제학부대학]",
		ChannelID:         "국제학부대학-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouInternationalNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouInternationalNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouInternationalNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouInternationalNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouInternationalNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouInternationalNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouInternationalNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouInternationalNotifier) sendNoticeToSlack(notice Notice) {

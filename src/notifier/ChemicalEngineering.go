...
type AjouCheNotifier BaseNotifier

func (AjouCheNotifier) New() *AjouCheNotifier {
  fsDocID := "ChemicalEngineering"
  ...
  return &AjouCheNotifier{
    BoxCount:          int(dbData["box"].(int64)),
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://www.ajou.ac.kr/che/board/notice.do",
    Source:            "[화학공학과]",
    ChannelID:         "화학공학과-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouCheNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouCheNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouCheNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouCheNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouCheNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouCheNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouCheNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouCheNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouSportsLeisureNotifier BaseNotifier

func (AjouSportsLeisureNotifier) New() *AjouSportsLeisureNotifier {
  fsDocID := "SportsLeisureStudies"
  ...
  return &AjouSportsLeisureNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://slez.ajou.ac.kr/slez/community/community03.jsp",
    Source:            "[스포츠레저학과]",
    ChannelID:         "스포츠레저학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouSportsLeisureNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouSportsLeisureNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouSportsLeisureNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouSportsLeisureNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouSportsLeisureNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouSportsLeisureNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouSportsLeisureNotifier) sendNoticeToSlack(notice Notice) {

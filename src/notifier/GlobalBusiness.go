...
type AjouGBNotifier BaseNotifier

func (AjouGBNotifier) New() *AjouGBNotifier {
	fsDocID := "GlobalBusiness"
	...
	return &AjouGBNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://gb.ajou.ac.kr/gb/admission/alram.do",
		Source:            "[글로벌경영학과]",
		ChannelID:         "글로벌경영학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouGBNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouGBNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouGBNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouGBNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouGBNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouGBNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouGBNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouGBNotifier) sendNoticeToSlack(notice Notice) {

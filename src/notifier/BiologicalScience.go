...
type AjouBiologyNotifier BaseNotifier

func (AjouBiologyNotifier) New() *AjouBiologyNotifier {
  fsDocID := "BiologicalScience"
  ...
  return &AjouBiologyNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://biology.ajou.ac.kr/biolog/board/board01.jsp",
    Source:            "[생명과학과]",
    ChannelID:         "생명과학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouBiologyNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouBiologyNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouBiologyNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouBiologyNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouBiologyNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouBiologyNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouBiologyNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouKoreanNotifier BaseNotifier

func (AjouKoreanNotifier) New() *AjouKoreanNotifier {
  fsDocID := "KoreanLanguageLiterature"
  ...
  return &AjouKoreanNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://kor.ajou.ac.kr/kor/board/board01.jsp",
    Source:            "[국어국문학과]",
    ChannelID:         "국어국문학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouKoreanNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouKoreanNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouKoreanNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouKoreanNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouKoreanNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouKoreanNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouKoreanNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouMSENotifier BaseNotifier

func (AjouMSENotifier) New() *AjouMSENotifier {
  fsDocID := "MaterialsScienceEngineering"
  ...
  return &AjouMSENotifier{
    BoxCount:          int(dbData["box"].(int64)),
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://mse.ajou.ac.kr/mse/board/notice.do",
    Source:            "[첨단신소재공학과]",
    ChannelID:         "첨단신소재공학과-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouMSENotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouMSENotifier) scrapeNotice() []Notice {
...
func (notifier *AjouMSENotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouMSENotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouMSENotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouMSENotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouMSENotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouMSENotifier) sendNoticeToSlack(notice Notice) {

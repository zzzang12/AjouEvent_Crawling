...
type AjouCultureContentsNotifier BaseNotifier

func (AjouCultureContentsNotifier) New() *AjouCultureContentsNotifier {
	fsDocID := "ajouCultureContents"
	...
	return &AjouCultureContentsNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://culture.ajou.ac.kr/culture/board/board01.jsp",
		Source:            "[문화콘텐츠학과]",
		ChannelID:         "문화콘텐츠학과-공지사항",
		FsDocID:           fsDocID,
		NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
	}
}

func (notifier *AjouCultureContentsNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouCultureContentsNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouCultureContentsNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouCultureContentsNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouCultureContentsNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouCultureContentsNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouCultureContentsNotifier) sendNoticeToSlack(notice Notice) {

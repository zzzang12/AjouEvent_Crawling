...
type AjouSociologyNotifier BaseNotifier

func (AjouSociologyNotifier) New() *AjouSociologyNotifier {
	fsDocID := "ajouSociology"
	...
	return &AjouSociologyNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://soci.ajou.ac.kr/soci/community/community03.jsp",
		Source:            "[사회학과]",
		ChannelID:         "사회학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouSociologyNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouSociologyNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouSociologyNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouSociologyNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouSociologyNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouSociologyNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouSociologyNotifier) sendNoticeToSlack(notice Notice) {

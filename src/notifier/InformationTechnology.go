...
type AjouITNotifier BaseNotifier

func (AjouITNotifier) New() *AjouITNotifier {
	fsDocID := "InformationTechnology"
...
func (notifier *AjouITNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouITNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouITNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouITNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouITNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouITNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouIENotifier BaseNotifier

func (AjouIENotifier) New() *AjouIENotifier {
  fsDocID := "IndustrialEngineering"
  ...
  return &AjouIENotifier{
    BoxCount:          int(dbData["box"].(int64)),
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://www.ajou.ac.kr/ie/academic/notice.do",
    Source:            "[산업공학과]",
    ChannelID:         "산업공학과-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouIENotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouIENotifier) scrapeNotice() []Notice {
...
func (notifier *AjouIENotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouIENotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouIENotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouIENotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouIENotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouIENotifier) sendNoticeToSlack(notice Notice) {

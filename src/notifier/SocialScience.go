...
type AjouCossNotifier BaseNotifier

func (AjouCossNotifier) New() *AjouCossNotifier {
	fsDocID := "SocialScience"
	...
	return &AjouCossNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://coss.ajou.ac.kr/coss/community/community01.do",
		Source:            "[사회과학대학]",
		ChannelID:         "사회과학대학-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouCossNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouCossNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouCossNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouCossNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouCossNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouCossNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouCossNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouCossNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouGraduateNotifier BaseNotifier

func (AjouGraduateNotifier) New() *AjouGraduateNotifier {
	fsDocID := "ajouGraduate"
	...
	return &AjouGraduateNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://ajou.ac.kr/gs/community/notice.do",
		Source:            "[대학원]",
		ChannelID:         "대학원-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouGraduateNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouGraduateNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouGraduateNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouGraduateNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouGraduateNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouGraduateNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouGraduateNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouGraduateNotifier) sendNoticeToSlack(notice Notice) {

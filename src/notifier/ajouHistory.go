...
type AjouHistoryNotifier BaseNotifier

func (AjouHistoryNotifier) New() *AjouHistoryNotifier {
	fsDocID := "ajouHistory"
	...
	return &AjouHistoryNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://history.ajou.ac.kr/history/board/board01.jsp",
		Source:            "[사학과]",
		ChannelID:         "사학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouHistoryNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouHistoryNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouHistoryNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouHistoryNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouHistoryNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouHistoryNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouHistoryNotifier) sendNoticeToSlack(notice Notice) {

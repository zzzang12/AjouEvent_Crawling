...
type AjouMobilityNotifier BaseNotifier

func (AjouMobilityNotifier) New() *AjouMobilityNotifier {
  fsDocID := "AIMobilityEngineering"
...
func (notifier *AjouMobilityNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouMobilityNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouMobilityNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouMobilityNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouMobilityNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouMobilityNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouMobilityNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouEnvNotifier BaseNotifier

func (AjouEnvNotifier) New() *AjouEnvNotifier {
  fsDocID := "EnvironmentalSafetyEngineering"
  ...
  return &AjouEnvNotifier{
    BoxCount:          int(dbData["box"].(int64)),
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://www.ajou.ac.kr/env/board/notice.do",
    Source:            "[환경안전공학과]",
    ChannelID:         "환경안전공학과-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouEnvNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouEnvNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouEnvNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouEnvNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouEnvNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEnvNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEnvNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouEnvNotifier) sendNoticeToSlack(notice Notice) {

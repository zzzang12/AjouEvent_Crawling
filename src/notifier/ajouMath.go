...
type AjouMathNotifier BaseNotifier

func (AjouMathNotifier) New() *AjouMathNotifier {
	fsDocID := "ajouMath"
	...
	return &AjouMathNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://math.ajou.ac.kr/math/board/board01.jsp",
		Source:            "[수학과]",
		ChannelID:         "수학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouMathNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouMathNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouMathNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouMathNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouMathNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouMathNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouMathNotifier) sendNoticeToSlack(notice Notice) {

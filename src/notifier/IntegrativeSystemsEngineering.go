...
type AjouISENotifier BaseNotifier

func (AjouISENotifier) New() *AjouISENotifier {
  fsDocID := "IntegrativeSystemsEngineering"
  ...
  return &AjouISENotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://ise.ajou.ac.kr/ise/board/notice.jsp",
    Source:            "[융합시스템공학과]",
    ChannelID:         "융합시스템공학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouISENotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouISENotifier) scrapeNotice() []Notice {
...
func (notifier *AjouISENotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouISENotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouISENotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouISENotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouISENotifier) sendNoticeToSlack(notice Notice) {

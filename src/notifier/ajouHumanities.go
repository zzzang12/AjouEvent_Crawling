...
type AjouHumanitiesNotifier BaseNotifier

func (AjouHumanitiesNotifier) New() *AjouHumanitiesNotifier {
	fsDocID := "ajouHumanities"
	...
	return &AjouHumanitiesNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://ajou.ac.kr/human/community/community01.do",
		Source:            "[인문대학]",
		ChannelID:         "인문대학-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouHumanitiesNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouHumanitiesNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouHumanitiesNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouHumanitiesNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouHumanitiesNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouHumanitiesNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouHumanitiesNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouHumanitiesNotifier) sendNoticeToSlack(notice Notice) {

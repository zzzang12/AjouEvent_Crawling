...
type AjouEconomicsNotifier BaseNotifier

func (AjouEconomicsNotifier) New() *AjouEconomicsNotifier {
	fsDocID := "ajouEconomics"
	...
	return &AjouEconomicsNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://econ.ajou.ac.kr/econ/community/community03.jsp",
		Source:            "[경제학과]",
		ChannelID:         "경제학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouEconomicsNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouEconomicsNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouEconomicsNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouEconomicsNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouEconomicsNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEconomicsNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouEconomicsNotifier) sendNoticeToSlack(notice Notice) {

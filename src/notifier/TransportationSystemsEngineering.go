...
type AjouTSENotifier BaseNotifier

func (AjouTSENotifier) New() *AjouTSENotifier {
  fsDocID := "TransportationSystemsEngineering"
  ...
  return &AjouTSENotifier{
    BoxCount:          int(dbData["box"].(int64)),
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://www.ajou.ac.kr/tse/board/board03.do",
    Source:            "[교통시스템공학과]",
    ChannelID:         "교통시스템공학과-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouTSENotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouTSENotifier) scrapeNotice() []Notice {
...
func (notifier *AjouTSENotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouTSENotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouTSENotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouTSENotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouTSENotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouTSENotifier) sendNoticeToSlack(notice Notice) {

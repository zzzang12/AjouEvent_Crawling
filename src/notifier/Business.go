...
type AjouBizNotifier BaseNotifier

func (AjouBizNotifier) New() *AjouBizNotifier {
	fsDocID := "Business"
	...
	return &AjouBizNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://biz.ajou.ac.kr/biz/community/notice.do",
		Source:            "[경영대학]",
		ChannelID:         "경영대학-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouBizNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouBizNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouBizNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouBizNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouBizNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouBizNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouBizNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouBizNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouMDCNotifier BaseNotifier

func (AjouMDCNotifier) New() *AjouMDCNotifier {
  fsDocID := "MilitaryDigitalConvergence"
  ...
  return &AjouMDCNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://mdc.ajou.ac.kr/mdc/board/board01.jsp",
    Source:            "[국방디지털융합학과]",
    ChannelID:         "국방디지털융합학과-공지사항",
    FsDocID:           fsDocID,
    NumNoticeSelector: "#jwxe_main_content > div > div.list_wrap > table > tbody > tr",
  }
}

func (notifier *AjouMDCNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouMDCNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouMDCNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouMDCNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouMDCNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouMDCNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouMDCNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouPbaNotifier BaseNotifier

func (AjouPbaNotifier) New() *AjouPbaNotifier {
  fsDocID := "PublicAdministration"
  ...
  return &AjouPbaNotifier{
    MaxNum:            int(dbData["num"].(int64)),
    URL:               "https://pba.ajou.ac.kr/pba/community/community03.jsp",
    Source:            "[행정학과]",
    ChannelID:         "행정학과-공지사항",
    FsDocID:           fsDocID,
...
func (notifier *AjouPbaNotifier) Notify() {
  defer func() {
    recover()
  }()
...
func (notifier *AjouPbaNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouPbaNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouPbaNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouPbaNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouPbaNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouPbaNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouEngineeringNotifier BaseNotifier

func (AjouEngineeringNotifier) New() *AjouEngineeringNotifier {
	fsDocID := "ajouEngineering"
	...
	return &AjouEngineeringNotifier{
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://ajou.ac.kr/eng/community/notice.do",
		Source:            "[공과대학]",
		ChannelID:         "공과대학-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouEngineeringNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouEngineeringNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouEngineeringNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouEngineeringNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouEngineeringNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEngineeringNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEngineeringNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouEngineeringNotifier) sendNoticeToSlack(notice Notice) {

...
type AjouNSNotifier BaseNotifier

func (AjouNSNotifier) New() *AjouNSNotifier {
	fsDocID := "NaturalScience"
	...
	return &AjouNSNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://ns.ajou.ac.kr/ns/board/notice.do",
		Source:            "[자연과학대학]",
		ChannelID:         "자연과학대학-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouNSNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouNSNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouNSNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouNSNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouNSNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouNSNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouNSNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouNSNotifier) sendNoticeToSlack(notice Notice) {

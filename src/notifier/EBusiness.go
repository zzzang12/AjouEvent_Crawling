...
type AjouEBizNotifier BaseNotifier

func (AjouEBizNotifier) New() *AjouEBizNotifier {
	fsDocID := "EBusiness"
	...
	return &AjouEBizNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://ebiz.ajou.ac.kr/ebiz/board/notice.do",
		Source:            "[e비즈니스학과]",
		ChannelID:         "e비즈니스학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouEBizNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouEBizNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouEBizNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouEBizNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouEBizNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEBizNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouEBizNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouEBizNotifier) sendNoticeToSlack(notice Notice) {

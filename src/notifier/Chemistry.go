...
type AjouChemNotifier BaseNotifier

func (AjouChemNotifier) New() *AjouChemNotifier {
	fsDocID := "Chemistry"
	...
	return &AjouChemNotifier{
		BoxCount:          int(dbData["box"].(int64)),
		MaxNum:            int(dbData["num"].(int64)),
		URL:               "https://chem.ajou.ac.kr/chem/board/notice.do",
		Source:            "[화학과]",
		ChannelID:         "화학과-공지사항",
		FsDocID:           fsDocID,
...
func (notifier *AjouChemNotifier) Notify() {
	defer func() {
		recover()
	}()
...
func (notifier *AjouChemNotifier) scrapeNotice() []Notice {
...
func (notifier *AjouChemNotifier) checkHTML(doc *goquery.Document) error {
...
func (notifier *AjouChemNotifier) isInvalidHTML(doc *goquery.Document) bool {
...
func (notifier *AjouChemNotifier) scrapeBoxNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouChemNotifier) scrapeNumNotice(doc *goquery.Document) []Notice {
...
func (notifier *AjouChemNotifier) getNotice(sel *goquery.Selection, noticeChan chan Notice) {
...
func (notifier *AjouChemNotifier) sendNoticeToSlack(notice Notice) {
